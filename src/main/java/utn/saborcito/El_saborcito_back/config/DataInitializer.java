    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            Imagen imagenHamburguesaBbq = imagenRepo
                    .save(Imagen.builder().url("./public/img/productos/hamburguesas/hamburguesabbq.png")
                            .build());
            Imagen imagenHamburguesaClasicaNueva = imagenRepo
                    .save(Imagen.builder().url("./public/img/productos/hamburguesas/hamburguesaclásica.png")
                            .build());
            Imagen imagenHamburguesaConQueso = imagenRepo
                    .save(Imagen.builder().url("./public/img/productos/hamburguesas/hamburguesaconqueso.png")
                            .build());
            Imagen imagenHamburguesaVegetariana = imagenRepo
                    .save(Imagen.builder().url("./public/img/productos/hamburguesas/hamburguesavegetariana.png")
                            .build());
            ...
            Imagen imagenCervezaArtesanal = imagenRepo
                    .save(Imagen.builder().url("./public/img/productos/bebidas/cervezaartesanal.png")
                            .build());
            ...
            ArticuloManufacturado pizzaMozzarella = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder()
                            ...
                            .precioVenta(4500.0)
                            .categoria(categoriaPizzas)
                            .imagen(imagenPizza) // Se mantiene la imagen genérica de pizza o se puede cambiar
                            .build());
            ...
            ArticuloManufacturado pizzaCuatroQuesos = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Pizza Cuatro Quesos")
                            ...
                            .categoria(categoriaPizzas).imagen(imagenPizzaCuatroQuesos).build());
            // Aquí irían los detalles de la pizza cuatro quesos
            ...
            ArticuloManufacturado pizzaHawaiana = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Pizza Hawaiana")
                            ...
                            .categoria(categoriaPizzas).imagen(imagenPizzaHawaiana).build());
            // Aquí irían los detalles de la pizza hawaiana
            ...
            ArticuloManufacturado pizzaMargherita = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Pizza Margherita")
                            ...
                            .categoria(categoriaPizzas).imagen(imagenPizzaMargherita).build());
            // Aquí irían los detalles de la pizza margherita
            ...
            ArticuloManufacturado pizzaPepperoni = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Pizza Pepperoni")
                            ...
                            .categoria(categoriaPizzas).imagen(imagenPizzaPepperoni).build());
            // Aquí irían los detalles de la pizza pepperoni
            ...
            ArticuloManufacturado hamburguesaBbq = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Hamburguesa BBQ")
                            .descripcion("Hamburguesa con salsa BBQ, panceta y cebolla caramelizada.")
                            .precioVenta(4200.0).tiempoEstimadoMinutos(18)
                            .categoria(categoriaHamburguesas).imagen(imagenHamburguesaBbq).build());
            // Aquí irían los detalles de la hamburguesa BBQ
            ...
            ArticuloManufacturado hamburguesaConQueso = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Hamburguesa con Queso")
                            ...
                            .categoria(categoriaHamburguesas).imagen(imagenHamburguesaConQueso).build());
            // Aquí irían los detalles de la hamburguesa con queso
            ...
            ArticuloManufacturado hamburguesaVegetariana = articuloManufacturadoRepo
                    .save(ArticuloManufacturado.builder().denominacion("Hamburguesa Vegetariana")
                            ...
                            .categoria(categoriaHamburguesas).imagen(imagenHamburguesaVegetariana).build());
            // Aquí irían los detalles de la hamburguesa vegetariana
