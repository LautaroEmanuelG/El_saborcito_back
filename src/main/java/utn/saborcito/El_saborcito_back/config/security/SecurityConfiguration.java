...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http,InactivityTimeoutFilter inactivityTimeoutFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                .requestMatchers("/api/public", "/api/clientes/registro").permitAll()
                                .requestMatchers("/api/empleados/registrar").hasAuthority("admin")
